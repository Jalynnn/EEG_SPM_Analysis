...
D_original = spm_eeg_load('C:/Users/Jalynn/Desktop/BDF_EEG_Files/P11/spmeeg_P11BDF.mat'); % MODIFY HERE (1/8)
...
S_bc.timewin = [2762.35, 2777.488];  % Set baseline window (start and end samples)
...
save(fullfile(preparedDataDir, 'modified_D_1.mat'), 'modified_D_1');
